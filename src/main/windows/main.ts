...
function registerIpcHandlers(): void {
  ...
  ipcMain.handle("auth:logout", async (event) => {
    ...
    // Reload all windows (React app will show onboarding since localStorage is cleared by renderer)
...
export function createWindow(options?: { chatId?: string; subChatId?: string }): BrowserWindow {
  ...
  // Load the renderer - no OAuth gate, onboarding is handled in the React app
