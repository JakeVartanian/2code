 ...
 * Supports legacy (~/.2code/worktrees/{projectId}/{chatId}/) and
 * new format (~/.2code/worktrees/{projectName}/{worktreeFolder}/).
 *
...
export function resolveProjectPathFromWorktree(
  ...
  const worktreeMarker = path.join(".2code", "worktrees")
  ...
  try {
    ...
    // Path format: /Users/.../.2code/worktrees/{projectSlug}/{worktreeFolder}
    const worktreeBase = path.join(os.homedir(), ".2code", "worktrees")
